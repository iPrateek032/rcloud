/* Description: 
Check whether user is able to import invalid file (for eg: .gist)
*/

//Begin test
casper.test.begin("Importing invalid file (gist) file using import Rmarkdown file option ", 5, function suite(test) {
    ...
    casper.then(function (){
        this.click("#import-notebook-file-dialog > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > span:nth-child(1)");
        console.log("Clicking on cancel button to check whether, session div has produced error or not");
        this.wait(2000);
        this.test.assertSelectorHasText("#session-info", "Error in fun(...) : failed to create new notebook", "session div has produced error, if we try to import gist file");
    })
