/* Description: 
Check whether notebook description is displayed or not for invalid file
*/

//Begin test
casper.test.begin("Check file description for invalid files  ", 5, function suite(test) {
