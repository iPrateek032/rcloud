...
//         this.click('#accordion-right > div:nth-child(3) > div:nth-child(1)');//Open workspace div
//         this.waitForSelector("#enviewer-body-wrapper", function(){
...
//             var df = this.fetchText("#viewer-body > table:nth-child(1)");
